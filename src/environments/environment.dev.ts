...
export const environment = {
  ...
  redirectUri: "https://dev.data.toyota.com",
  postLogoutRedirectUri: "https://dev.data.toyota.com",
  validateAuthority: false,
  navigateToLoginRequestUrl: true,
  cacheLocation: "sessionStorage",
  versionCheckURL: "http://dev.data.toyota.com/version.json",
  apiUrl: 'https://dev.admin.data.toyota.com/api', // For Engine B
  gdx: {
