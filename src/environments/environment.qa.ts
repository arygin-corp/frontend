...
export const environment = {
  ...
  hotjar: '',
  isIE,
  clientId: "948694de-76b4-4aec-9a16-39fee8855e61",
  authority: "https://login.microsoftonline.com/b7be26fb-0007-4e34-9f39-088aa7bc74b0",
  redirectUri: "https://qa.data.toyota.com",
  postLogoutRedirectUri: "https://qa.data.toyota.com",
  validateAuthority: false,
  navigateToLoginRequestUrl: true,
  cacheLocation: "sessionStorage",
  versionCheckURL: "http://qa.data.toyota.com/version.json",
  apiUrl: 'https://qa.admin.data.toyota.com/api', // For Engine B
  gdx: {
