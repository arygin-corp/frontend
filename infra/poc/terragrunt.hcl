...
terraform {
  ...
  source = "git@github.com:Toyota-Motor-North-America/ace-aws-blueprint-spa.git//terraform?ref=v6.0.3"
}

locals {
  aws_account_id                = "715662994982"
  aws_region                    = "us-east-1"
  terraform_state_s3_bucket     = "poc-spa-angular-example-spa-angular-tfstate"
...
inputs = {
  ...
  cf_create_default_response_headers_policy = true  # Boolean
  ...
  #cf_route53_zone_name_to_create = null
  ...
  #cf_response_headers_policy_id = null
  ...
  #waf_managed_rules = {} 
  #waf_add_default_zscalar_ips = false # Boolean
  #waf_advanced_managed_rules = {}
  #waf_add_tmna_network_device_ips = false # Boolean
  #waf_add_vpc_private_ips = false # Boolean
  ...
  # team = null 
  # data_classification = "no_classification"
}
