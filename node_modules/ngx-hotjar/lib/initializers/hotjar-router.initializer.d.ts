 ...
 */
export declare const NGX_HOTJAR_ROUTER_INITIALIZER_PROVIDER: Provider;
/**
 ...
 */
export declare function HotjarRouterInitializer(hjService: NgxHotjarService): (c: ComponentRef<any>) => Promise<void>;
