...
import { PLATFORM_ID, Directive, Inject, Input, HostBinding, NgModule } from '@angular/core';
...
class RedZoomDirective {
    ...
    move() {
        ...
        const frameRelativePos = map(sub(thumbSize, frameSize), (value, axis) => (value === 0 ? 0 : (frameLimitedPos[axis] - thumbPos[axis]) / value));
...
RedZoomDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0, type: RedZoomDirective, deps: [{ token: i0.ElementRef }, { token: i0.Renderer2 }, { token: i0.NgZone }, { token: PLATFORM_ID }], target: i0.ɵɵFactoryTarget.Directive });
RedZoomDirective.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.0.1", type: RedZoomDirective, selector: "[redZoom]", inputs: { src: "src", lensSrc: ["redZoom", "lensSrc"], thumbSrc: ["redZoomThumb", "thumbSrc"], lazy: ["redZoomLazy", "lazy"], classes: ["redZoomClass", "classes"], behavior: ["redZoomBehavior", "behavior"], wheel: ["redZoomMouseWheel", "wheel"], errorMessage: ["redZoomErrorMessage", "errorMessage"] }, host: { properties: { "attr.src": "this.src" } }, exportAs: ["redZoom"], usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0, type: RedZoomDirective, decorators: [{
            type: Directive,
            args: [{
                    selector: '[redZoom]',
                    exportAs: 'redZoom',
...
RedZoomModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0, type: RedZoomModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
RedZoomModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0, type: RedZoomModule, declarations: [RedZoomDirective], exports: [RedZoomDirective] });
RedZoomModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0, type: RedZoomModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0, type: RedZoomModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
                        RedZoomDirective
