    ...
    ***************************************************************************** */
    ...
    var RedZoomTemplate = /** @class */ (function () {
        function RedZoomTemplate() {
            ...
            var getElement = function (selector) {
                var element = _this.template.querySelector(selector);
                if (!element) {
        ...
        Object.defineProperty(RedZoomTemplate.prototype, "classes", {
            set: function (classes) {
                var _a, _b;
                (_a = this.template.classList).remove.apply(_a, __spreadArray([], __read(this.appliedClasses)));
                classes = classes.trim();
                if (classes) {
                    this.appliedClasses = classes.replace(/ +/, ' ').split(' ');
                    (_b = this.template.classList).add.apply(_b, __spreadArray([], __read(this.appliedClasses)));
                }
            },
            enumerable: false,
            configurable: true
        ...
        RedZoomTemplate.prototype.setProperties = function (properties) {
            ...
            Object.keys(properties).forEach(function (name) {
                _this.template.style.setProperty(name, properties[name]);
            });
        };
    ...
    var RedZoomImage = /** @class */ (function () {
        function RedZoomImage(element, listener, className) {
            ...
            this.destroy = function () {
                _this.element.removeEventListener('load', internalListener);
                _this.element.removeEventListener('error', internalListener);
            };
            if (className !== null) {
    ...
    var RedZoomDirective = /** @class */ (function () {
        function RedZoomDirective(element, renderer, zone, platformId) {
            ...
            this.mouseEnter = function (event) {
                ...
                if (_this.behavior === 'hover') {
                    ...
                    unListenLeave = _this.renderer.listen(document, 'mousedown', function (downEvent) {
        ...
        RedZoomDirective.prototype.move = function () {
            ...
            var frameRelativePos = map(sub(thumbSize, frameSize), function (value, axis) { return (value === 0 ? 0 : (frameLimitedPos[axis] - thumbPos[axis]) / value); });
    ...
    RedZoomDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0__namespace, type: RedZoomDirective, deps: [{ token: i0__namespace.ElementRef }, { token: i0__namespace.Renderer2 }, { token: i0__namespace.NgZone }, { token: i0.PLATFORM_ID }], target: i0__namespace.ɵɵFactoryTarget.Directive });
    RedZoomDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.0.1", type: RedZoomDirective, selector: "[redZoom]", inputs: { src: "src", lensSrc: ["redZoom", "lensSrc"], thumbSrc: ["redZoomThumb", "thumbSrc"], lazy: ["redZoomLazy", "lazy"], classes: ["redZoomClass", "classes"], behavior: ["redZoomBehavior", "behavior"], wheel: ["redZoomMouseWheel", "wheel"], errorMessage: ["redZoomErrorMessage", "errorMessage"] }, host: { properties: { "attr.src": "this.src" } }, exportAs: ["redZoom"], usesOnChanges: true, ngImport: i0__namespace });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0__namespace, type: RedZoomDirective, decorators: [{
                type: i0.Directive,
                args: [{
                        selector: '[redZoom]',
                        exportAs: 'redZoom',
            ...
            return [{ type: i0__namespace.ElementRef }, { type: i0__namespace.Renderer2 }, { type: i0__namespace.NgZone }, { type: undefined, decorators: [{
                            type: i0.Inject,
                            args: [i0.PLATFORM_ID]
                        }] }];
        }, propDecorators: { src: [{
    ...
    RedZoomModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0__namespace, type: RedZoomModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    RedZoomModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0__namespace, type: RedZoomModule, declarations: [RedZoomDirective], exports: [RedZoomDirective] });
    RedZoomModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0__namespace, type: RedZoomModule });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.1", ngImport: i0__namespace, type: RedZoomModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        declarations: [
                            RedZoomDirective
